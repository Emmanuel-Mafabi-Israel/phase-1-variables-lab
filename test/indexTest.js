...
describe('index.js', function () {
  describe('companyName', function () {
    it('is set as Mafabi', function () {
      expect(companyName).to.equal('Mafabi');
    });
  ...
  describe('companyCeo', function () {
    it('is declared as equal to Emmanuel Mafabi', function () {
      expect(companyCeo).to.equal('Emmanuel Mafabi');
    });
